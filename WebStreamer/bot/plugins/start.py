...
<i><u>𝗪𝗔𝗥𝗡𝗜𝗡𝗚 🚸</u></i>
<b>🔞 Pʀᴏɴ ᴄᴏɴᴛᴇɴᴛ ʟᴇᴀᴅ ᴛᴏ ᴘᴇʀᴍᴀɴᴇɴᴛ ʙᴀɴ ʏᴏᴜ.</b>\n
<i><b>🧰 Bᴏᴛ Mᴀɪɴᴛᴀɪɴᴇᴅ Bʏ :-</b>@TGTech4U</i>"""
...
async def start(b, m):
    ...
    if usr_cmd == "/start":
        ...
        stream_link = "https://filetolink4u.ml/{}/{}".format(get_msg.message_id, file_name) if Var.ON_HEROKU or Var.NO_PORT else \
